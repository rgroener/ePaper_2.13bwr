...
void epap_draw_image(uint8_t with, uint8_t hight, uint8_t x, uint8_t y, uint8_t *image)
{
	...
	epap_write_data((with/8)*hight, image);				//send data to display
...
int main(void)
{
	...
	epap_draw_image(80,80,1,30, image);
	epap_refresh();
	LED_EIN;
